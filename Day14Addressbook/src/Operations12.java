...
public class Operations12{
   ...
   public void sortStreamByCity() {  
    	...
    	Stream<Person> person1 = person.stream().sorted(Comparator.comparing(Person::getCity));       
    	person1.forEach(System.out::println);
	...
	public void searchStreamByFirstName() {
	   ...
	   Stream<Person> matchedFirstName = person.stream().filter(p -> p.getFirstName().equals(firstName)); 
